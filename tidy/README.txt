...
There are 5 different measurements gathered in the original data set (in (T)ime Domain) -
	1. BodyAcc (Body Acceleration),
	2. BodyAccJerk (Body acceleration jerk signals derived from body linear acceleration and angular velocity),
	3. BodyGyro (Body Angular velocity),
	4. BodyGyroJerk (Body gyro jerk signals derived from body linear acceleration and angular velocity)
	5. GravityAcc (Gravity Acceleration)
